...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WalletDocSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12WalletDocSDK24WD3DSecureViewController")
@interface WD3DSecureViewController : UIViewController <UIScrollViewDelegate, UITextFieldDelegate, UIWebViewDelegate>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC12WalletDocSDK23WDAddCardViewController")
@interface WDAddCardViewController : UIViewController <UITextFieldDelegate>
- (void)viewDidLoad;
- (void)viewWillDisappear:(BOOL)animated;
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC12WalletDocSDK10WDCardView")
@interface WDCardView : UIView <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC12WalletDocSDK15WDMaskTextField")
@interface WDMaskTextField : UITextField
...
SWIFT_CLASS("_TtC12WalletDocSDK5WDSDK")
@interface WDSDK : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIStoryboardSegue;

SWIFT_CLASS("_TtC12WalletDocSDK27WDTransactionViewController")
@interface WDTransactionViewController : UIViewController
- (void)viewDidLoad;
